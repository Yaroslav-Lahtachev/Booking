package com.lahtachev.booking.controller;


import com.lahtachev.booking.dao.OfferDAO;
import com.lahtachev.booking.dao.OrderHistoryDAO;
import com.lahtachev.booking.dao.SellerDAO;
...
import com.lahtachev.booking.model.OffersInfo;
...
public class MainController {
    ...
    public String reserveAddInfo(Model model,
        ...
        if (orderHistoryDAO.CheckReserveOfferByIdAndDate(orderHistoryInfo.getIdOffer(), orderHistoryInfo.getDateStart(), orderHistoryInfo.getDateFinish())) {
            ...
            Seller seller = sellerDAO.findSellerByOffer(orderHistoryInfo.getIdOffer());
    ...
    public String blockPage(Model model,
        ...
        User user = usersDAO.findByIdUser(id);
        ...
        switch (status) {
            ...
            case 1:
                setStatus = "ROLE_USER";
                if (!sellerDAO.findOffersByIdUser(user).isEmpty()) {
                    setStatus = "ROLE_SELLER";
                    orderHistoryDAO.blockUnblockOffer(id, "unblock");
                }
                break;
        }
        usersDAO.changeUserStatus(id, setStatus);
